...
namespace Examples.TEMP
{
    public class TestMono : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                "Enter Normal ProcedureA".LogInfo();
            });
            ...
            _procedureManager.RegisterProcedure(ProcedureId.ExampleProcedureA, ProcedureChangeStage.LeaveLate, _ =>
            {
                "Leave Late ProcedureA".LogInfo();
            });
            
            _procedureManager.RegisterProcedure(ProcedureId.ExampleProcedureB, ProcedureChangeStage.EnterNormal, _ =>
            {
                "Enter Normal ProcedureB".LogInfo();
            });
        }
