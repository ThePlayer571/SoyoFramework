...
{
    [CustomEditor(typeof(SoyoButton), true)]
    public class SoyoButtonEditor : ButtonEditor
    {
        public override void OnInspectorGUI()
        {
            ...
            // 只显示实际声明在本类及其子类的字段
            DrawCustomFields(so, type, typeof(Button));
        }
        ...
        private void DrawScriptField()
        {
            ...
            {
                // 注意：CustomEditor(typeof(SoyoButton), true) 允许子类也用这个 Editor
